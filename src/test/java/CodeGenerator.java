...
import com.ma.wallet.core.constant.Constants;
...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:oracle:thin:@(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=118.178.128.200)(PORT=1521))(CONNECT_DATA=(SERVER=DEDICATED)(SERVICE_NAME=predb)))";
    private static final String JDBC_USERNAME = "wallet";
    private static final String JDBC_PASSWORD = "wallet123";
    ...
    private static final String AUTHOR = "FengBin";//@author
    private static final String DATE = new SimpleDateFormat("yyyy-MM-dd").format(new Date());//@date

    public static void main(String[] args) {
        genCode("wallet_white_ip");
